...
<body>
    ...
    include '../component/Contact/banner.php';
    include '../component/Contact/contact-information.php';
    include '../component/Contact/contact-form.php';
    include '../component/Contact/map.php';
